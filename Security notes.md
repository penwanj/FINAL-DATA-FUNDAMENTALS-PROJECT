...
-This document describes breakdown of how security system is designed and protected including role-based access control, row-level security, and custom function for Admin(s).
